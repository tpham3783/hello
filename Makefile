...
ACLOCAL = ${SHELL} /usr/local/src/hello-2.7/build-aux/missing --run aclocal-1.11
AMTAR = ${SHELL} /usr/local/src/hello-2.7/build-aux/missing --run tar
AUTOCONF = ${SHELL} /usr/local/src/hello-2.7/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /usr/local/src/hello-2.7/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /usr/local/src/hello-2.7/build-aux/missing --run automake-1.11
AWK = mawk
CC = gcc
...
HAVE_WMEMSET = 1
HAVE__BOOL = 1
HELP2MAN = ${SHELL} /usr/local/src/hello-2.7/build-aux/missing --run help2man
...
LTLIBINTL = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /usr/local/src/hello-2.7/build-aux/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /usr/local/src/hello-2.7
abs_srcdir = /usr/local/src/hello-2.7
abs_top_builddir = /usr/local/src/hello-2.7
abs_top_srcdir = /usr/local/src/hello-2.7
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
dvidir = ${docdir}
exec_prefix = ${prefix}
gl_LIBOBJS =  close-stream.o closeout.o quotearg.o xmalloc.o
gl_LTLIBOBJS =  close-stream.lo closeout.lo quotearg.lo xmalloc.lo
gltests_LIBOBJS = 
gltests_LTLIBOBJS = 
...
install_sh = ${SHELL} /usr/local/src/hello-2.7/build-aux/install-sh
